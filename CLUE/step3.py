...
process = cms.Process('RECO',Phase2C22I13M9,ticl_v5)
...
# process.hgcalValidator.maxRapidityCP = cms.double(2.02)
# process.hgcalValidator.minRapidityCP = cms.double(1.6)
# process.hgcalValidator.histoProducerAlgoBlock.maxEne = cms.double(1000.0)
process.hgcalValidator.histoProducerAlgoBlock.nintEne = cms.int32(100)
process.hgcalValidator.histoProducerAlgoBlock.nintEneClperlay = cms.int32(55)
process.hgcalValidator.histoProducerAlgoBlock.VScoreCutCPtoLC = cms.vdouble(0.1, 0.4, 1.0)
process.hgcalValidator.histoProducerAlgoBlock.VScoreCutLCtoCP = cms.vdouble(0.1, 0.4, 1.0)
#{EDITS}
