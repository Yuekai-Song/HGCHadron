...
# with command line options: step4 -s HARVESTING:@phase2Validation+@phase2+@miniAODValidation+@miniAODDQM --conditions auto:phase2_realistic_T33 --mc --geometry ExtendedRun4D121 --scenario pp --filetype DQM --era Phase2C22I13M9 -n -1 --filein file:step3_inDQM.root --fileout file:step4.root --no_exec --python_filename step4.py
