...
struct HGVHistoProducerAlgoHistograms {
  ...
  std::unordered_map<int, std::vector<dqm::reco::MonitorElement*>> h_responce_reco2sim_perlayer;
  std::unordered_map<int, std::vector<dqm::reco::MonitorElement*>> h_responce_sim2reco_perlayer;
  ...
  dqm::reco::MonitorElement* h_response_reg_trackstersCLUE3DHigh2caloparticle;
  dqm::reco::MonitorElement* h_response_reg_ticlcandidate2caloparticle;
  dqm::reco::MonitorElement* h_response_reg_layerClusters2caloparticle;

  dqm::reco::MonitorElement* h_caloparticle_energy_frac_ee;
  dqm::reco::MonitorElement* h_caloparticle_energy_frac_bh;
  std::vector<dqm::reco::MonitorElement*> h_responce_reco2sim_all;
  std::vector<dqm::reco::MonitorElement*> h_responce_reco2sim_e;
  std::vector<dqm::reco::MonitorElement*> h_responce_reco2sim_h;
  std::vector<dqm::reco::MonitorElement*> h_responce_sim2reco_all;
  std::vector<dqm::reco::MonitorElement*> h_responce_sim2reco_e;
  std::vector<dqm::reco::MonitorElement*> h_responce_sim2reco_h;
